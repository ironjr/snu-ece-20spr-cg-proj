...
constexpr float DEFAULT_CAMERA_SPRINT_MULTIPLIER   =   3.0f;
...
constexpr float DEFAULT_CAMERA_PITCH_SENSITIVITY   =   0.07f;
constexpr float DEFAULT_CAMERA_YAW_SENSITIVITY     =   0.1f;
constexpr float DEFAULT_CAMERA_ROLL_SENSITIVITY    =   0.1f;
